...
def generate_launch_description():
	...
	urdf_file = os.path.join(pkg_gazebo_sims,'urdf','demo_block4.xacro.urdf')
	...
	#sdf_model_path = "/home/preston/urc_navigation/src/urc_slam/urdf/demo_block4.sdf"
	sdf_model_path = os.path.join(get_package_share_directory('urc_sim'),'urdf','demo_block4.sdf')
	...
	n2 = Node(
		...
		arguments = ['-topic','robot_description','-entity','ramp-model','-x','0','-y','0','-z','0.5'],
		output = 'screen'
		)
	...
	n3 = Node(
		package = 'gazebo_ros',
		executable = 'spawn_entity.py',
		arguments = ['-file',sdf_model,'-entity','wheel1-model','-x','0.75','-y','0.0','-z','1.2'],
		output = 'screen'
		)
